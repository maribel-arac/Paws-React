				  ...
				  <div className="modal-dialog" role="document">
				    <div className="modal-content">
				      <div className="modal-header">
				        <h5 className="modal-title" id="exampleModalLabel">Mascota perdida</h5>
				      ...
				      <div  className="modal-footer">
				        ...
				        <button type="button" onClick={this.sendFormFirebase}  data-dismiss="modal" className="btn btn-success">Publicar</button>
				      </div>
				    </div>
				  </div>
				</div>
